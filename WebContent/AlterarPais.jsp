                    ...
                    <form action="controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="populacao" id="populacao" placeholder="Digite a população do país" required value="${pais.populacao }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="area">Área</label>
                                <input type="text" class="form-control" name="area" id="area" placeholder="Digite a Área do país" required="required" value="${pais.area }">
                            </div>
                        </div>
                        <hr />
